...
# Emissions
This section will explore the emission and compliance of the EU ETS. The figure below shows the aggregrated verified emissions and aggregated free allocated allowances across all entities by year.
